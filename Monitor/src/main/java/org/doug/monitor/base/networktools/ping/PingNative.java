package org.doug.monitor.base.networktools.ping;

import com.orhanobut.logger.Logger;

import org.doug.monitor.base.networktools.IPTools;
    ...
    public static PingResult ping(InetAddress host, int timeOutMillis) throws IOException, InterruptedException {
        ...
        if (address != null) {
            if (IPTools.isIPv6Address(address)) {
                ...
                Logger.w("AndroidNetworkTools", "Could not identify " + address + " as ipv4 or ipv6, assuming ipv4");
            }
        } else {
