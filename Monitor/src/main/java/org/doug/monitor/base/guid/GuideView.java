package org.doug.monitor.base.guid;
...
public class GuideView extends RelativeLayout {
    ...
    public GuideView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (context instanceof Activity) {
            ...
            Logger.i("screenWidth : " + mScreenWidth + "  screenHeight : " + mScreenHeight);
        } else {
    ...
    private void getTargetViewPosition() {
        Logger.i("getTargetViewPosition");
        if (mParams.mTargetView.getWidth() > 0 && mParams.mTargetView.getHeight() > 0) {
            ...
            hasMeasure = false;
            Logger.i("targetView is not measured, please user view.post(Runnable run) initialize GuideView");
        }
    }
