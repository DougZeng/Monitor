...
public class Toaster implements View.OnClickListener {
    ...
    public static void showToast(Context context, String msg, int animationDuration, int visibleDuration, int layoutRes) {
        ...
        if (visibleDuration < 100) {
            throw new IllegalArgumentException("Visible duration must be more than 99ms");
        }
        ...
        final FrameLayout contentFrameLayout = ((Activity) context).findViewById(android.R.id.content);
    ...
    public void show() {
        ...
        final FrameLayout ContentFrameLayout = activity.findViewById(android.R.id.content);
