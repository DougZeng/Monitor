...
public class CustomListAdapter extends RecyclerView.Adapter<CustomListAdapter.CustomViewHolder> {
    ...
    private void handleLocationInfo(CustomViewHolder holder, int position) {
        switch (position) {
            ...
            case 4:
                ...
                break;
            case 5:
                holder.textView.setText("CountryCode:");
                holder.desc.setText(((DeviceLocation) object).getCountryCode());
                break;
            case 6:
                holder.textView.setText("Postal Code:");
    ...
    private void handleAppInfo(CustomViewHolder holder, int position) {
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                holder.textView.setText("Package Name:");
                holder.desc.setText(((App) object).getPackageName());
                break;
            case 2:
                holder.textView.setText("Activity Name:");
                holder.desc.setText(((App) object).getActivityName());
                break;
            case 3:
                holder.textView.setText("App Version Name:");
                holder.desc.setText(((App) object).getAppVersionName());
                break;
            case 4:
                holder.textView.setText("App Version Code:");
    ...
    private void handleMemoryInfo(CustomViewHolder holder, int position) {
        switch (position) {
            case 0:
                holder.textView.setText("Has external Momeny Card:");
    ...
    private void handleDeviceInfo(CustomViewHolder holder, int position) {
        switch (position) {
            case 0:
                holder.textView.setText("Manufacturer:");
            ...
            case 1:
                ...
                break;
            case 2:
                holder.textView.setText("Build VersionCode Name:");
                holder.desc.setText(((Device) object).getBuildVersionCodeName());
                break;
            case 3:
                holder.textView.setText("Release Build Version:");
            ...
            case 4:
                ...
                break;
            case 5:
                holder.textView.setText("Fingerprint:");
                holder.desc.setText(((Device) object).getFingerprint());
                break;
            case 6:
                holder.textView.setText("Hardware:");
                holder.desc.setText(((Device) object).getHardware());
                break;
            case 7:
                holder.textView.setText("Radio Version:");
