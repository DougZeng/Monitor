package org.doug.monitor.factorytest.view;
...
public class ListViewForReport {
    ...
    public static List<Map<String, Object>> listMaps;
    static int count = 0;
    ...
    private static class MyAdapter extends SimpleAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tvTestItem.setText(R.string.test);
            tvTestItem.append(i + ":");
            ...
            tvTestResult.setTextColor(testResultColor);
